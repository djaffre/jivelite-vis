...
function skin(self, s)
	Framework:setVideoMode(1280, 960, 0, true)
...
--------- ICONBAR ---------
	...
	local NP_ARTISTALBUM_FONT_SIZE = 100
	local NP_TRACK_FONT_SIZE = 100
	...
	s.nowplaying = _uses(s.window, {
		...
		npprogress = {
			position = LAYOUT_NONE,
			x = 540,
			y = TITLE_HEIGHT + 29 + 26 + 32 + 32 + 23 + 220,
			padding = { 0, 40, 0, 0 },
